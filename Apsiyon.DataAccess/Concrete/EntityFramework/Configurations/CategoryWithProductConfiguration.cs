...
{
    public class CategoryWithProductConfiguration : IEntityTypeConfiguration<CategoryWithProduct>
    {
        public void Configure(EntityTypeBuilder<CategoryWithProduct> modelBuilder)
        {
